            ...
            <div className="circle blur-circle4"></div>
                <div className="form creation">
                    <div className="form-header">
                        ...
                        <div><i className="fa-solid fa-user-plus auth-icon"></i></div>
                    </div>
...
function ConfirmMdp({ sendMdp, showConfirmMdp, setShowConfirmMdp }: any) {
    ...
    function validateForm() {
        setValiderLabel("...");
        setTimeout(() => {
            sendMdp(mdp); // joker: last step => setMpd
...
function Connexion({ setShowConnexion, setCurrent, setDisplayUserStatus }: any) {
    ...
    try {
        const client = new Client();
        const response = await client.authentification(telEmail, mdp);
        ...
        if (response.status === 200) {
            ...
            // alert("Client data:"+clientResponse.data);
            ...
            setIsCorrect({ telEmail: "none", mdp: "inline" });
        } else {
        ...
        <div className="auth">
            ...
            <div className="form connexion">
                <div className="form-header">
                    ...
                    <div><i className="fa-solid fa-sign-in auth-icon"></i></div>
